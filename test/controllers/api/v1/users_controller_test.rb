...
class Api::V1::UsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create user' do
    assert_difference('User.count') do
      post api_v1_users_url, params: { user: { email: 'test@test.org', password: '123456', password_confirmation: '123456' } }, as: :json
    end
  ...
  test 'should update user' do
    patch api_v1_user_url(@user),
          ...
          headers: { Authorization: JsonWebToken.encode(session_token: @user.generate_session_token) },
          as: :json
    assert_response :success
  end
